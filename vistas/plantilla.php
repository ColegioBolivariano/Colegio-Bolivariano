...
<head>
    ...
    <title>Sistema De monitoreo | IECB</title>
    <link rel="shortcut icon" href="vistas/assets/dist/img/logo_tecno" type="image/x-icon">
...
<body class="hold-transition sidebar-mini">
    ...
    //$('.btnEliminarCliente').attr('disabled', true);
...
<body>
    <?php include "vistas/login-copy.php" ?>
</body>
