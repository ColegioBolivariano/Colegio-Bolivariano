...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
        <img src="vistas/assets/dist/img/logo_tecno.png" alt="Logo Tecno" class="brand-image img-circle elevation-3" style="opacity: .9">
        <span class="brand-text font-weight-light"><br> Sistema De Monitoreo</span>
    </a>
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
            ...
            <input type="hidden" value="<?php echo $_SESSION["usuario"]->carre_id;  ?>" id="text_Idcarrera">
            <input type="text" value="<?php echo $_SESSION["usuario"]->id_usuario;  ?>" id="text_Idprincipal" hidden>
            <input type="text" value="<?php echo $_SESSION["usuario"]->id_perfil_usuario;  ?>" id="text_Idperfil" hidden>
        </div>
    </div>
