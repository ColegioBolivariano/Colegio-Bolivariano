                      ...
                      <div class="row">
                          ...
                          <div class="col-lg-6">
                              <div class="form-group mb-2">
                                  ...
                                  <input type="text" class=" form-control form-control-sm" id="text_dni"
                                      name="text_dni" placeholder="Dni" required>
                                  <div class="invalid-feedback">Debe ingresar el DNi del usuaio</div>
                          ...
                          <div class="col-lg-6">
                              <div class="form-group mb-2">
                                  ...
                                  <input type="text" class=" form-control form-control-sm" id="text_cargo"
                                      name="text_cargo" placeholder="Cargo" required>
                          ...
                          <div class="col-lg-6">
                              <div class="form-group mb-2">
                                  <label for="" class="">
                                      <span class="small"> Dependencia</span><span class="text-danger">*</span>
                                  </label>
                                  <input type="text" class=" form-control form-control-sm" id="text_depen"
                                      name="text_depen" placeholder="Dependencia" required>
                                  <div class="invalid-feedback">Debe ingresar una dependencia</div>
                          ...
                          <div class="col-lg-6">
                              <div class="form-group mb-2">
                                  ...
                                  <input type="text" class=" form-control form-control-sm" id="text_correo"
                                      name="text_correo" placeholder="Correo " required>
                          ...
                          <div class="col-lg-6">
                              <div class="form-group mb-2">
                                  ...
                                  <input type="text" class=" form-control form-control-sm" id="text_cel"
                                      name="text_cel" placeholder="Celular " required>
                          ...
                          <div class="col-lg-6">
                              <div class="form-group mb-2">
                                  <label for="" class="">
                                      <span class="small"> Und. Organica</span><span class="text-danger">*</span>
                                  </label>
                                  <input type="text" class=" form-control form-control-sm" id="text_organo"
                                      name="text_organo" placeholder="Und. organica " required>
                                  <div class="invalid-feedback">Debe ingresar un organo</div>
                          ...
                          <div class="col-lg-6">
                              <div class="form-group mb-2">
                                  ...
                                  <input type="text" class=" form-control form-control-sm" id="text_ubicacion"
                                      name="text_ubicacion" placeholder="Ubicacion " required>
                                  <div class="invalid-feedback">Debe ingresar una ubicacion</div>
                          ...
                          <div class="col-lg-12">
                              <div class="form-group mb-2">
                                  ...
                                  <input type="text" class=" form-control form-control-sm" id="text_direc"
                                      name="text_direc" placeholder="Direccion " required>
...
$(document).ready(function() {
            ...
            if (form.checkValidity() === true) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        datos.append("dni", $("#text_dni").val());
                        datos.append("cargo", $("#text_cargo").val());
                        datos.append("dependencia", $("#text_depen").val());
                        datos.append("correo", $("#text_correo").val());
                        datos.append("celular", $("#text_cel").val());
                        datos.append("organo", $("#text_organo").val());
                        datos.append("ubicacion", $("#text_ubicacion").val());
                        datos.append("direccion", $("#text_direc").val());
    ...
    $("#tbl_usuarios tbody").on('click', '.btnEditarUsuario', function() {
        ...
        $("#select_carrera").val(data[9]);
        $("#text_dni").val(data[11]);
        $("#text_cargo").val(data[12]);
        $("#text_depen").val(data[13]);
        $("#text_correo").val(data[14]);
        $("#text_cel").val(data[15]);
        $("#text_organo").val(data[16]);
        $("#text_ubicacion").val(data[17]);
        $("#text_direc").val(data[18]);
