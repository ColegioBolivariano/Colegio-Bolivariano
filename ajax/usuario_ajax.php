...
if (isset($_POST['accion']) && $_POST['accion'] == 1) { //LISTAR USUARIOS EN DATA TABLE
    ...
    $registroUsuario->carre_id = $_POST["carre_id"];
    $registroUsuario->dni = $_POST["dni"];
    $registroUsuario->cargo = $_POST["cargo"];
    $registroUsuario->dependencia = $_POST["dependencia"];
    $registroUsuario->correo = $_POST["correo"];
    $registroUsuario->celular = $_POST["celular"];
    $registroUsuario->organo = $_POST["organo"];
    $registroUsuario->ubicacion = $_POST["ubicacion"];
