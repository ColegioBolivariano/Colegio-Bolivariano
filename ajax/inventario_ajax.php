...
class AjaxInventario
{
    ...
    /*===================================================================*/
    public function  getListarInventario($carre_id)
    {
        $Inventario = InventarioControlador::ctrListarInventario($carre_id);
...
if (isset($_POST['accion']) && $_POST['accion'] == 1) {
    ...
    $Inventario->getListarInventario($_POST["carre_id"]);
}
