...
class UsuarioControlador{
    ...
    public function login(){
        ...
        if(isset($_POST["loginUsuario"])){ //texbox de usuario
            ...
            if(count($respuesta)> 0){
                ...
                echo '
                    <script>
                            window.location = "http://localhost/Bolivariano_56008/";
                    </script>
                ...
                echo '
                    <script>
                    fncSweetAlert("error","Usuario y/o password inválido","http://localhost/Bolivariano_56008/");
                </script>
    ...
    /*===================================================================*/
     //REGISTRAR USUARIOS
     /*===================================================================*/
     static public function ctrRegistrarUsuario($nombre_usuario, $apellido_usuario, $usuario, $clave, $id_perfil_usuario, $carre_id , $dni, $cargo, $dependencia, $correo, $celular , $organo ,$ubicacion ,$direccion)
     {
         $registroUsuario = UsuarioModelo::mdlRegistrarUsuario($nombre_usuario, $apellido_usuario, $usuario, $clave, $id_perfil_usuario, $carre_id, $dni, $cargo, $dependencia, $correo, $celular, $organo ,$ubicacion ,$direccion);
