...
class UsuarioModelo
{
    ...
    REGISTRAR USUARIO
    =============================================*/
    static public function mdlRegistrarUsuario($nombre_usuario, $apellido_usuario, $usuario, $clave, $id_perfil_usuario, $carre_id , $dni, $cargo, $dependencia, $correo, $celular, $organo ,$ubicacion ,$direccion)
    {
        try {
            //$fecha = date('Y-m-d');
            $stmt = Conexion::conectar()->prepare("INSERT INTO usuarios(nombre_usuario, 
                                                                          ...
                                                                          usuario,
                                                                          clave ,
                                                                          id_perfil_usuario, estado, carre_id, dni, cargo,dependencia, correo,  celular, organo, ubicacion, direccion) 
                                                                VALUES (:nombre_usuario, 
                                                                        :apellido_usuario,
                                                                        :usuario,
                                                                        :clave,
                                                                        :id_perfil_usuario, '1', :carre_id, :dni, :cargo, :dependencia, :correo, :celular, :organo, :ubicacion, :direccion)");
            ...
            $stmt->bindParam(":organo", $organo, PDO::PARAM_STR);
